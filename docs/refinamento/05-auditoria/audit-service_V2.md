...
> **Versão V2 — consolidação do modelo administrativo e transacional.**
>
> Esta versão preserva integralmente as regras da V1 e torna explícitos
> os catálogos administrativos, as tabelas transacionais, os
> relacionamentos, exemplos de dados e um cenário consolidado ponta a ponta.
>
...
| Transacional | `AUDIT_OPERATION`, `AUDIT_EVENT`, `AUDIT_CYCLE`, `AUDIT_SNAPSHOT` | Preserva fatos, operações, ciclos e snapshots. |
